...
void SciTEGTK::CreateMenu() {
	...
	GtkItemFactoryCallback menuSig = GtkItemFactoryCallback(MenuSignal);
		SciTEItemFactoryEntry menuItems[] = {
	                                      ...
	                                      {"/Edit/S_how Calltip", "<control>T", menuSig, IDM_SHOWCALLTIP, 0},
	                                      {"/Edit/sep2", NULL, NULL, 0, "<Separator>"},
					      ...
					      {"/Edit/Block Co_mment or Uncomment", "<control>Q", menuSig, IDM_BLOCK_COMMENT, 0},
	                                      ...
	                                      {"/Edit/Make _Selection Uppercase", "<control>U", menuSig, IDM_UPRCASE, 0},
	                                      {"/Edit/Make Selection _Lowercase", "<control>L", menuSig, IDM_LWRCASE, 0},
	                                      ...
	                                      {"/Search/Toggle Bookmar_k", "<control>M", menuSig, IDM_BOOKMARK_TOGGLE, 0},
					      ...
					      {"/_Plugins", NULL, NULL, 0, "<Branch>"},
	                                      ...
	                                      {"/Plugins/Tool0", NULL, menuSig, IDM_TOOLS + 0, 0},
	                                      {"/Plugins/Tool1", NULL, menuSig, IDM_TOOLS + 1, 0},
	                                      {"/Plugins/Tool2", NULL, menuSig, IDM_TOOLS + 2, 0},
	                                      {"/Plugins/Tool3", NULL, menuSig, IDM_TOOLS + 3, 0},
	                                      {"/Plugins/Tool4", NULL, menuSig, IDM_TOOLS + 4, 0},
	                                      {"/Plugins/Tool5", NULL, menuSig, IDM_TOOLS + 5, 0},
	                                      {"/Plugins/Tool6", NULL, menuSig, IDM_TOOLS + 6, 0},
	                                      {"/Plugins/Tool7", NULL, menuSig, IDM_TOOLS + 7, 0},
	                                      {"/Plugins/Tool8", NULL, menuSig, IDM_TOOLS + 8, 0},
	                                      {"/Plugins/Tool9", NULL, menuSig, IDM_TOOLS + 9, 0},

	                                      {"/Plugins/Tool10", NULL, menuSig, IDM_TOOLS + 10, 0},
	                                      {"/Plugins/Tool11", NULL, menuSig, IDM_TOOLS + 11, 0},
	                                      {"/Plugins/Tool12", NULL, menuSig, IDM_TOOLS + 12, 0},
	                                      {"/Plugins/Tool13", NULL, menuSig, IDM_TOOLS + 13, 0},
	                                      {"/Plugins/Tool14", NULL, menuSig, IDM_TOOLS + 14, 0},
	                                      {"/Plugins/Tool15", NULL, menuSig, IDM_TOOLS + 15, 0},
	                                      {"/Plugins/Tool16", NULL, menuSig, IDM_TOOLS + 16, 0},
	                                      {"/Plugins/Tool17", NULL, menuSig, IDM_TOOLS + 17, 0},
	                                      {"/Plugins/Tool18", NULL, menuSig, IDM_TOOLS + 18, 0},
	                                      {"/Plugins/Tool19", NULL, menuSig, IDM_TOOLS + 19, 0},

	                                      {"/Plugins/Tool20", NULL, menuSig, IDM_TOOLS + 20, 0},
	                                      {"/Plugins/Tool21", NULL, menuSig, IDM_TOOLS + 21, 0},
	                                      {"/Plugins/Tool22", NULL, menuSig, IDM_TOOLS + 22, 0},
	                                      {"/Plugins/Tool23", NULL, menuSig, IDM_TOOLS + 23, 0},
	                                      {"/Plugins/Tool24", NULL, menuSig, IDM_TOOLS + 24, 0},
	                                      {"/Plugins/Tool25", NULL, menuSig, IDM_TOOLS + 25, 0},
	                                      {"/Plugins/Tool26", NULL, menuSig, IDM_TOOLS + 26, 0},
	                                      {"/Plugins/Tool27", NULL, menuSig, IDM_TOOLS + 27, 0},
	                                      {"/Plugins/Tool28", NULL, menuSig, IDM_TOOLS + 28, 0},
	                                      {"/Plugins/Tool29", NULL, menuSig, IDM_TOOLS + 29, 0},

	                                      {"/Plugins/Tool30", NULL, menuSig, IDM_TOOLS + 30, 0},
	                                      {"/Plugins/Tool31", NULL, menuSig, IDM_TOOLS + 31, 0},
	                                      {"/Plugins/Tool32", NULL, menuSig, IDM_TOOLS + 32, 0},
	                                      {"/Plugins/Tool33", NULL, menuSig, IDM_TOOLS + 33, 0},
	                                      {"/Plugins/Tool34", NULL, menuSig, IDM_TOOLS + 34, 0},
	                                      {"/Plugins/Tool35", NULL, menuSig, IDM_TOOLS + 35, 0},
	                                      {"/Plugins/Tool36", NULL, menuSig, IDM_TOOLS + 36, 0},
	                                      {"/Plugins/Tool37", NULL, menuSig, IDM_TOOLS + 37, 0},
	                                      {"/Plugins/Tool38", NULL, menuSig, IDM_TOOLS + 38, 0},
	                                      {"/Plugins/Tool39", NULL, menuSig, IDM_TOOLS + 39, 0},

	                                      {"/Plugins/Tool40", NULL, menuSig, IDM_TOOLS + 40, 0},
	                                      {"/Plugins/Tool41", NULL, menuSig, IDM_TOOLS + 41, 0},
	                                      {"/Plugins/Tool42", NULL, menuSig, IDM_TOOLS + 42, 0},
	                                      {"/Plugins/Tool43", NULL, menuSig, IDM_TOOLS + 43, 0},
	                                      {"/Plugins/Tool44", NULL, menuSig, IDM_TOOLS + 44, 0},
	                                      {"/Plugins/Tool45", NULL, menuSig, IDM_TOOLS + 45, 0},
	                                      {"/Plugins/Tool46", NULL, menuSig, IDM_TOOLS + 46, 0},
	                                      {"/Plugins/Tool47", NULL, menuSig, IDM_TOOLS + 47, 0},
	                                      {"/Plugins/Tool48", NULL, menuSig, IDM_TOOLS + 48, 0},
	                                      {"/Plugins/Tool49", NULL, menuSig, IDM_TOOLS + 49, 0},
	...
	SciTEItemFactoryEntry  menuItemsHelp[] = {
	                                          ...
	                                          {"/Help/Quick _Help", "F1", menuSig, IDM_HELP, 0},
	                                          {"/Help/_sdlBasic Reference Guide", "", menuSig, IDM_HELP_SCITE, 0},
	                                          {"/Help/_About sdlBasic IDE", "", menuSig, IDM_ABOUT, 0},
	                                      };
