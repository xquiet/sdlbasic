...
const char *contributors[] = {
                                 ...
                                 "Maxim Baranov",
                                 "Icons by Zoiba",
                                 "    based on Nuvola icons by David Vignoni",
                                 "    http://www.icon-king.com ",
                                 "    sdlBasic logo by Paulo Silva",
				 "    http://www15.brinkster.com/nitrofurano"
...
void SciTEBase::SetAboutMessage(WindowID wsci, const char *appTitle) {
	if (wsci) {
		...
		SetAboutStyle(wsci, 0, ColourDesired(0, 0xaa, 0));
		
		Platform::SendScintilla(wsci, SCI_STYLESETSIZE, 0, fontSize);
		//Platform::SendScintilla(wsci, SCI_STYLESETBACK, 0, ColourDesired(0, 0xff, 0xff).AsLong());
		...
		AddStyledText(wsci, " 20051016\n", 1);
		AddStyledText(wsci, "    " __DATE__ " " __TIME__ "\n\n", 1);
		AddStyledText(wsci, "based upon SciTE  ", 3);
		AddStyledText(wsci, GetTranslationToAbout("Version").c_str(), trsSty);
		AddStyledText(wsci, " 1.64\n", 1);
		SetAboutStyle(wsci, 2, ColourDesired(0, 0, 0));
		AddStyledText(wsci, "    ", 1);
		...
		AddStyledText(wsci, "December 1998-June 2005.\n", 3);
