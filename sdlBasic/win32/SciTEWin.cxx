...
void SciTEWin::GetDefaultDirectory(char *directory, size_t size) {
	...
	char *home=(char *)malloc(20);
	strcpy(home,"../share/sdlBasic/");
	GetSciTEPath(directory, static_cast<unsigned int>(size), home);
	directory=(char *) malloc(20);
	directory="../share/sdlBasic/\0";
}
...
//#endif
	...
	if (hmod == NULL)
		::MessageBox(NULL, "The Scintilla DLL could not be loaded.  sdlBasicSciTE will now close", "Error loading Scintilla", MB_OK | MB_ICONERROR);
#endif
